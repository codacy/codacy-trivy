...
// Pin versions required by xeol's transitive deps (anchore/syft, anchore/fangs).
// Syft expects tablewriter v0.0.5 API; viper v1.18.2 matches fangs' DecoderConfigOption.
replace (
